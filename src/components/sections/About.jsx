const About = () => {
  return (
    <div className="flex flex-col gap-[24px] items-center justify-center w-full max-w-[1290px] mx-auto px-4 md:px-20 md:items-start">
      <h1 className="text-white font-inter text-5xl font-black tracking-[-1.68px] md:text-6xl md:text-left lg:text-7xl">
        Sobre Nós
      </h1>
      <p className="opacity-[0.5] text-white text-center font-inter text-[16px] tracking-[-0.64px] md:text-left lg:text-2xl">
